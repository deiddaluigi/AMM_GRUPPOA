...
INSERT INTO accounts(id, username, password, tipo_utente )
VALUES
    (default, 'MarioBianchi','aaabbb', 'cliente'),
    (default, 'FrancoMilani','cccddd', 'cliente'),
    (default, 'VeronicaMarini', 'eeefff', 'cliente');
...
INSERT INTO accounts(id, username, password, tipo_utente )
VALUES (default, 'stampantisrl','ggghhh', 'venditore');

INSERT INTO venditori(account_id, ragione_sociale, partita_iva)
VALUES (4, 'StampantiSrl', '01234567890');

INSERT INTO conti_correnti (account_id, numero, codice_accesso, saldo)
VALUES 
    (1, 1001, 1111, 1100),
    (2, 1002, 2222, 1200),
    (3, 1003, 3333, 1300),
