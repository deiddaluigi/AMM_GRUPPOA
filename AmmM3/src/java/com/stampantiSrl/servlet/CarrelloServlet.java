    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            (boolean) sessione.getAttribute("clienteLoggedIn")) {
                ArrayList<StampanteInVendita> stampantiDaAcquistare =
                        (ArrayList<StampanteInVendita>) sessione.getAttribute("carrello");
                request.setAttribute("listaStampantiCarrello", stampantiDaAcquistare);
