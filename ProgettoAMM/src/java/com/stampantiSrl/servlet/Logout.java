...
public class Logout extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        sessione.invalidate();
        StampantiInVenditaFactory.getInstance().closeFactoryInstance();
        ContiCorrentiFactory.getInstance().closeFactoryInstance();
        UtentiFactory.getInstance().closeFactoryInstance();
